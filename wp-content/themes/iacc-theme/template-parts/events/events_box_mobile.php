<div class="row member-box-nav">
  <div class="col-md-12">
    <div class="accordion accordion-flush" id="accordionFlushExample">
      ...
      <div  style="text-align:center;">
        <h2 class="nav-item" id="flush-headingTwo" onclick="click_past()">
        <button class="nav-link accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#flush-collapseTwo" aria-expanded="false" aria-controls="flush-collapseOne"  >Past Events</button>       
        </h2>
