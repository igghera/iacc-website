<div id="board-testimonial" style="display:none;">

<div id="boardtestimonial" class="carousel slide" data-bs-ride="carousel" style="margin-top:63px">
  
  <div class="carousel-inner">

  <?php $counttest = 0;?>

  <?php while(has_sub_field('board_testimonial')): ?>

  <?php
  
  $piazza_testimonial_img = get_sub_field('testimonial_photo');
  $piazza_testimonial_name = get_sub_field('testimonial_name');
  $piazza_testimonial_citation = get_sub_field('testimonial_citation');
  ?>
  ...
  <button class="carousel-control-prev" type="button" data-bs-target="#boardtestimonial" data-bs-slide="prev">
    <div class="slider-button"><span class="carousel-control-prev-icon" aria-hidden="true"></span></div>
    <span class="visually-hidden">Previous</span>
  </button>
  <button class="carousel-control-next" type="button" data-bs-target="#boardtestimonial" data-bs-slide="next">
