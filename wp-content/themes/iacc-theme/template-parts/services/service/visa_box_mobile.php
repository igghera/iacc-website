<div class="row row-boxes" style="margin-top:60px;">
    ...
    <div class="col-12">
        ...
        <div class="col-md-12">
            <div class="query-box" id="query-box-<?php echo $faq_count;?>" style="background-color:transparent !important;">
...
function openhost() {
    ...
    document.getElementById('faq-to-open-hc').style.marginBottom = "50px";
    document.getElementById('faq-to-open-hc').style.marginTop = "50px";
	document.getElementById('faq-to-open-ap').style.display = "none";
	document.getElementById('faq-to-open-ji').style.display = "none";
    document.getElementById('faq-to-open-hc').classList.add = "faq-mobile";
	document.getElementById('faq-to-open-ap').classlist.remove = "faq-mobile";
    document.getElementById('faq-to-open-ji').classList.remove = "faq-mobile";
...
function openap() {
    ...
    document.getElementById('faq-to-open-ap').style.marginBottom = "50px";
    document.getElementById('faq-to-open-ap').style.marginTop = "50px";
	document.getElementById('faq-to-open-ji').style.display = "none";
    document.getElementById('faq-to-open-hc').classList.remove = "faq-mobile";
	document.getElementById('faq-to-open-ap').classlist.add = "faq-mobile";
    document.getElementById('faq-to-open-ji').classList.remove = "faq-mobile";
}
...
function openji() {
    ...
    document.getElementById('faq-to-open-ji').style.marginBottom = "50px";
    document.getElementById('faq-to-open-ji').style.marginTop = "50px";
    document.getElementById('faq-to-open-hc').classList.remove = "faq-mobile";
	document.getElementById('faq-to-open-ap').classlist.remove = "faq-mobile";
    document.getElementById('faq-to-open-ji').classList.add = "faq-mobile";
}
